...
BibleInfo _$BibleInfoFromJson(Map<String, dynamic> json) => BibleInfo(
  ...
  json['alphabet'] == null
      ? null
      : BibleInfoAlphabet.fromJson(json['alphabet'] as Map<String, dynamic>),
  json['mark'] as String?,
  json['name'] as String?,
...
Map<String, dynamic> _$BibleInfoToJson(BibleInfo instance) => <String, dynamic>{
  ...
  'publishers': const BibleInfoPublishersConverter().toJson(
    instance.publishers,
  ),
...
Map<String, dynamic> _$BibleInfoAlphabetToJson(
  BibleInfoAlphabet instance,
) => <String, dynamic>{
  'script': instance.script,
  'name': instance.name,
  'direction': const AlphabetDirectionConverter().toJson(instance.direction),
...
Book _$BookFromJson(Map<String, dynamic> json) => Book(
  ...
  json['name_short'] as String?,
  const BookTestamentConverter().fromJson(json['testament'] as String?),
  (json['testament_order'] as num?)?.toInt(),
  json['book_order'] as String?,
  json['book_group'] as String?,
  (json['chapters'] as List<dynamic>?)?.map((e) => (e as num).toInt()).toList(),
  (json['content_types'] as List<dynamic>?)?.map((e) => e as String).toList(),
);
...
DefaultBible _$DefaultBibleFromJson(Map<String, dynamic> json) =>
    DefaultBible(json['audio'] as String?, json['video'] as String?);
...
_$VerseByLanguageResultMetadataPaginationFromJson(Map<String, dynamic> json) =>
    VerseByLanguageResultMetadataPagination(
      (json['total'] as num?)?.toInt(),
...
_$VerseByVersionResultMetadataPaginationFromJson(Map<String, dynamic> json) =>
    VerseByVersionResultMetadataPagination(
      (json['total'] as num?)?.toInt(),
      (json['count'] as num?)?.toInt(),
      (json['per_page'] as num?)?.toInt(),
